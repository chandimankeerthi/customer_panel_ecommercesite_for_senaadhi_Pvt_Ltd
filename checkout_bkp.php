...
while($rowGetToCart=$resultGetToCart->fetch_array()){ ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label for="inputofname" class="form-label">First Name</label>
                            <input type="text" class="form-control" id="inputofname" name="bfname"
                                value="<?php echo $_SESSION['customer_fname'];?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label for="inputolname" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="inputolname" name="blname"
                                value="<?php echo $rowGetToCart['customer_lname']; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input type="text" class="form-control" id="inputolname" name="bemail"
                                value="<?php echo $rowGetToCart['email']; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input type="text" class="form-control" id="inputolname" name="bcontact"
                                value="<?php echo $rowGetToCart['contact_number']; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Line 1</label>
                            <input type="text" class="form-control" id="inputolname" name="bresidence1"
                    ...
                    <div class="bg-light p-30">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" name="elname" placeholder="Doe">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>E-mail</label>
                                <input class="form-control" type="text" name="semail" placeholder="example@email.com">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mobile No</label>
                                <input class="form-control" type="text" name="scontact" placeholder="+9476 456 789">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Address Line 1</label>
                            ...
                            <div class="col-md-6 form-group">
                                <label>City</label>
                                <input class="form-control" type="text" name="bcity" placeholder="Kegalle">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>ZIP Code</label>
                                <input class="form-control" type="text" name="bpostal" placeholder="123">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-light p-30">
                        ...
                        <div class="form-group mb-4">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="banktransfer" name="paymentmethod"
