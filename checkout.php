...
$total_price=$_REQUEST['total_pricenew'];
$item_idnew=$_REQUEST['item_idnew'];
$sizenew=$_REQUEST['sizenew'];
$productPricenew=$_REQUEST['productPricenew'];
$colornew=$_REQUEST['colornew'];
$Productnamenew=$_REQUEST['Productnamenew'];
$deleveryfee=$_REQUEST['deleveryfee'];
$Productquanti=$_REQUEST['Productquanti'];
$product_cart_id=$_REQUEST['product_cart_id'];
...
$sql1="INSERT INTO `order_detail`(`buyer_fname`,`buyer_lname`,`buyer_email`,`buyer_contact`,`buyer_residence1`,`buyer_residence2`,`buyer_country`,`buyer_city`,`buyer_postalcode`,`shipping_fname`,`shipping_lname`,`shipping_email`,`shipping_contact`,`shipping_residence1`,`shipping_residence2`,`shipping_country`,`shipping_city`,`shipping_postalcode`,`Payement_method`,`total_price`,`item_id`,`size`,`product_cost`,`color_family`,`product_name`,`deleveryfee`)
VALUES ('$bfname','$blname','$bemail',$bcontact,'$bresidence1','$bresidence2','$bcountry','$bcity',$bpostal,'$sfname','$slname','$semail','$scontact','$sresidence1','$sresidence2','$scountry','$scity','$spostal','$Payement_method','$total_price','$item_idnew','$sizenew','$productPricenew','$colornew','$Productnamenew','$deleveryfee')";

$sql2 = "UPDATE product_details SET productQuantity = productQuantity - $Productquanti WHERE id = '$item_idnew'";


$sql3="DELETE FROM `cart` WHERE item_id=$product_cart_id";
                        ...
                        <div class="bg-light p-30">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" type="text" name="sfname"
                                        value="Same as the Delivery Details">
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" type="tel" name="scontact"
                                        value="Same as the Delivery Details">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="inputsresidence1" class="form-label">Address Line 1</label>
                                    <input class="form-control" type="text" name="sresidence1"
                                        value="Same as the Delivery Details">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="inputsresidence2" class="form-label">Address Line 2</label>
                                    <input class="form-control" type="text" name="sresidence2">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="inputscountry" class="form-label">Country</label>
                                    <input class="form-control" type="read" name="scountry">
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" type="text" name="spostal"
                                        value="Same as the Delivery Details">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="bg-light p-30 mb-5">
                        <div class="border-bottom">
                            <h6 class="mb-3">Products Cost</h6>
                            <?php
$coustemerid=$_SESSION['id'];
$totPrice=0;
$totItem=0;
...
while($rowGetToCart=$resultGetToCart->fetch_array()){ ?>
                            <div class="d-flex justify-content-between">
                                ...
                                <p><?php echo $rowGetToCart['Quantity'] ?>&nbsp;*
                                    &nbsp;RS.<?php echo ($rowGetToCart["productPrice"]* (100 - $rowGetToCart["discountpercentage"]))/100;?>
                                </p>
                            </div> <?php
                     $totPrice+=($rowGetToCart["productPrice"]* (100 - $rowGetToCart["discountpercentage"]))/100*$rowGetToCart['Quantity'];
                     $shipping_cost+=$rowGetToCart['shipping_cost']*$rowGetToCart['Quantity'];
                     $product_cart_id+=$rowGetToCart['id'];
                     
                     } ?>
                            <div class="col-md-6 form-group">
                                <label for="inputsproduct_cart_id" class="form-label"></label>
                                <input class="form-control" type="hidden" name="product_cart_id"
                                    value="<?php echo $product_cart_id; ?>">
                            </div>
                        ...
                        <!-- <a href="invoice.php" class="btn btn-block btn-danger font-weight-bold py-3">Generate Invoice</a> -->
                    </div>

                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                            <h5>Rs.<?php echo $totPrice+$shipping_cost; ?></h5>
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-light p-30">
                        ...
                        <div class="col-3">
                            <a href="invoice.php"><input type="submit" class="btn btn-primary" id="userInput"
                                    value="Place Order" name="InsertProduct" style="width: 300px; height: 50px;">
                        </div>
                    </div>
                </div>
                ...
                <?php
                                ...
                                $getToCartSql="SELECT * FROM cart  WHERE user_id='$coustemerid'";
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="inputsitem_idnew" class="form-label"></label>
                        <input class="form-control" type="hidden" name="item_idnew"
                            value="<?php echo $rowGetToCart['item_id']; ?>">
                    </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input class="form-control" type="hidden" name="Productnamenew"
                            value="<?php echo $rowGetToCart['Productname']; ?>">
                    </div>

                    <div class="col-md-6 form-group">
                        <label for="inputsproductPricenew" class="form-label"></label>
                        <input class="form-control" type="hidden" name="productPricenew"
                            value="<?php echo $rowGetToCart['Quantity'] ?>&nbsp;* &nbsp;RS.<?php echo ($rowGetToCart["productPrice"]* (100 - $rowGetToCart["discountpercentage"]))/100;?>">
                    </div>

                    <div class="col-md-6 form-group">
                        <label for="inputsproductPricenew" class="form-label"></label>
                        <input class="form-control" type="hidden" name="deleveryfee"
                            value="<?php echo $rowGetToCart['Quantity'] ?>&nbsp;*<?php echo $rowGetToCart['shipping_cost']; ?>">
                    </div>
                                ...
                                $totPrice+=($rowGetToCart["productPrice"]* (100 - $rowGetToCart["discountpercentage"]))/100*$rowGetToCart['Quantity'];
                                $shipping_cost+=$rowGetToCart['shipping_cost']*$rowGetToCart['Quantity'];
                                $quantity+=$rowGetToCart['Quantity'];
                ...
                <div class="pt-2">
                    <div class="d-flex justify-content-between mt-2">
                        ...
                        <label for="inputstotal_pricenew" class="form-label"></label>
                        <input class="form-control" type="hidden" name="total_pricenew"
                            value="<?php echo $totPrice+$shipping_cost; ?>">

                    </div>

                    <div class="col-md-6 form-group">
                        <label for="inputsProductquanti" class="form-label"></label>
                        <input class="form-control" type="hidden" name="Productquanti" value="<?php echo $quantity; ?>">
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="inputscolornew" class="form-label"></label>
                            <input class="form-control" type="hidden" name="colornew"
                                value="<?php echo $rowGetToCart['color']; ?>">
                        </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="inputssizenew" class="form-label"></label>
                            <input class="form-control" type="hidden" name="sizenew"
                                value="<?php echo $rowGetToCart['size']; ?>">
                        </div>
