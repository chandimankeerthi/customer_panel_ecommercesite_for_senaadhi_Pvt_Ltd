        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    <form action="search_fashion_maincate.php" method="GET">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="mainCategory" id="mainCategory">
                                <?php
                    $getMainCategory = "SELECT distinct(mainCat) FROM product_details where product_type='furniture' order by id asc";
