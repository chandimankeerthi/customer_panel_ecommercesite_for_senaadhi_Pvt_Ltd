...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">All Fashion</span>
                </nav>
            </div>
        </div>
    </div>
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="img/carousel-4.jpg"
    ...
    <div class="container pt-5 pb-3">
        ...
        <div class=" row px-xl-5">
            <?php
                    $query = "select * from products_new where main_category='Fashion'  order by id asc";
                    $result = mysqli_query($conn,$query);
                    if(mysqli_num_rows($result)>0){
                        while($row = mysqli_fetch_array($result)){
                            ?>
                ...
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            ...
                            <a class="btn btn-outline-dark btn-square" href="index.html"><i
