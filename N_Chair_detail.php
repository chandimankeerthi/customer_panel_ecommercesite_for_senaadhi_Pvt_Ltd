                    ...
                    <div class="d-flex mb-3 ">
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
                            ...
                            <select class="form-select" aria-label="Default select example" name="size">
                                <?php                                        
                                        $getCategory = "SELECT distinct(size) FROM product_details where mainCat='Trouser'";
                            ...
                            <div class="d-flex mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="colorfamily">
                                    ...
                                    $getCategory = "SELECT distinct(colorfamily) FROM product_details where mainCat='Chair' AND Productname='$getCategory1'";
                                    $resultSubCategory2 = $conn->query($getCategory);
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>Chair Category :<?php echo $row["sub_categorey"];?></p>
                            <p>Brand Name :<?php echo $row["brand"];?></p>
                            <p>Chair Arm Type :<?php echo $row["armtype"];?></p>
                            <p>Color Type :<?php echo $row["colorfamily"];?></p>
                            <p>Back Height Type :<?php echo $row["backheight"];?></p>
                            <p>Desk Chair Type :<?php echo $row["deskchairtype"];?></p>
                            <p>Upholstery Type :<?php echo $row["upholsterytype"];?></p>
                            <p>Adjustable Handle Availability :<?php echo $row["adjustablehandle"];?></p>
