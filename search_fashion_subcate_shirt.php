        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    <form action="search_fashion_subcate_shirt.php" method="GET">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="subCategory" id="subCategory">
                                ...
                                <?php
$getCategory="SELECT distinct(sub_categorey) FROM product_details WHERE mainCat='Shirt'";
...
?>
                                ...
                                <option value="<?php echo $rowSub1['sub_categorey'] ?>">
                                    <?php echo $rowSub1['sub_categorey'] ?>
                                </option>
                                <?php
}
        ?>
                        ...
                        <div class="form-group fashion-filters">
                            ...
                            <select class="form-control" name="gendertype" id="gendertype">
                                <option value="">All</option>
                                <?php
$getCategory="SELECT distinct(gendertype) FROM product_details WHERE mainCat='Shirt'";
$resultSubCategory1=$conn->query($getCategory);
while($rowSub1 = $resultSubCategory1->fetch_array()){
?>

                                <option value="<?php echo $rowSub1['gendertype'] ?>">
                                    <?php echo $rowSub1['gendertype'] ?>
                                </option>
                                <?php
}
        ?>
                        ...
                        <div class="form-group fashion-filters">
                            ...
                            <select class="form-control" name="brand" id="brand">
                                <option value="">All</option>
                                <?php
$getCategory="SELECT distinct(brand) FROM product_details WHERE mainCat='Shirt'";
$resultSubCategory1=$conn->query($getCategory);
while($rowSub1 = $resultSubCategory1->fetch_array()){
?>

                                <option value="<?php echo $rowSub1['brand'] ?>"><?php echo $rowSub1['brand'] ?>
                                </option>
                                <?php
}
        ?>
                        ...
                        <div class="form-group furniture-filters">
                            ...
                            <select class="form-control" name="size" id="size">
                                <option value="">All</option>
                                <?php
$getCategory="SELECT distinct(size) FROM product_details WHERE mainCat='Shirt'";
$resultSubCategory1=$conn->query($getCategory);
while($rowSub1 = $resultSubCategory1->fetch_array()){
?>

                                <option value="<?php echo $rowSub1['size'] ?>"><?php echo $rowSub1['size'] ?>
                                </option>
                                <?php
}
        ?>
                        ...
                        <div class="form-group furniture-filters">
                            ...
                            <select class="form-control" name="colorfamily" id="colorfamily">
                                <option value="">All</option>
                                <?php
$getCategory="SELECT distinct(colorfamily) FROM product_details WHERE mainCat='Shirt'";
$resultSubCategory1=$conn->query($getCategory);
while($rowSub1 = $resultSubCategory1->fetch_array()){
?>

                                <option value="<?php echo $rowSub1['colorfamily'] ?>">
                                    <?php echo $rowSub1['colorfamily'] ?>
                                </option>
                                <?php
}
        ?>
