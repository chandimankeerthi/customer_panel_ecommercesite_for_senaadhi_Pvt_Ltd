...
<body>
    ...
    <div class="container pt-5 pb-3">
        ...
        <div class=" row px-xl-5">
            ...
            <?php
           $query = "select * from product_details where product_type='fashion' and mainCat='T-shirt' and sub_categorey='Mens T-Shirts & Tops' and gendertype='Men' order by id asc";
