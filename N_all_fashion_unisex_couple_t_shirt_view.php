...
<body>
    ...
    <div class="container pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">ALL
                UNISEX COUPLE T-SHIRTS</span>
        </h2>
        <div class=" row px-xl-5">

            <?php
           $query = "select * from product_details where product_type='fashion' and mainCat='T-shirt' and sub_categorey='Unisexs Couple T-Shirts' order by id asc";
