...
<body>
    ...
    <div class="container pt-5 pb-3">
        ...
        <div class=" row px-xl-5">
            ...
            <?php
           $query = "select * from product_details where product_type='fashion' and mainCat='T-shirt' and sub_categorey='Womens T-Shirts' and gendertype='Women'  order by id asc";
