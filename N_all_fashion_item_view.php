...
<body>
    ...
    <div class="container pt-5 pb-3">
        ...
        <div class=" row px-xl-5">
            ...
            <?php
           $query = "select * from product_details where trending='T' and product_type='fashion' order by id asc";
...
?>
    ...
    <div class="container pt-5 pb-3">
        ...
        <div class=" row px-xl-5">
            ...
            <?php
           $query = "select * from product_details WHERE product_type='fashion' order by id asc";
           $result = mysqli_query($conn,$query);
           if(mysqli_num_rows($result)>0){
               while($row = mysqli_fetch_array($result)){
                   ?>
