...
<body>
    ...
    <!-- All Bedding Sets Start -->
    <div class="container pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">ALL HOME
                OFFICE CHAIRS PRODUCTS</span>
        </h2>
        <div class=" row px-xl-5">

            <?php
           $query = "select * from product_details where product_type='furniture' and sub_categorey='Home Office Chairs' order by id asc";
