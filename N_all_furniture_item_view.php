...
$image_dir="../uploads";
    if(isset($_REQUEST['add'])){
	    ...
	    $sqlAddCart="INSERT INTO cart VALUES($coustemerID,$itemId,1)";
...
<body>
    ...
    <div class="container pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">TRENDING
                PRODUCTS</span>
        </h2>
        <div class=" row px-xl-5">

            <?php
           $query = "select * from product_details where trending='T' and product_type='furniture' order by id asc";
                    ...
                    <form method="post" action="index.php?action=add&id=<?php echo $row["id"];?>">
                        <div class="product">
                            <div class="product-img position-relative overflow-hidden">
                                <img src="<?php echo $image_dir."/". $row["productImage1"];?>" width="190px"
...
?>
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h4 class="">
                                        <b><?php echo ($row["productPrice"]* (100 - $row["discountpercentage"]))/100;?></b>
                                    </h4>
    ...
    <div class="container pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">ALL
                FURNITURE PRODUCTS</span>
        </h2>
        <div class=" row px-xl-5">

            <?php
           $query = "select * from product_details WHERE product_type='furniture' order by id asc";
           $result = mysqli_query($conn,$query);
           if(mysqli_num_rows($result)>0){
               while($row = mysqli_fetch_array($result)){
                   ?>
