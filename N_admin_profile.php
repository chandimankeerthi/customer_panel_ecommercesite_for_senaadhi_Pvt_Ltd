...
<body>
    ...
    <form>
        <div class="container-fluid">
            ...
            <div class="row px-xl-5">
                <div class="col-lg-10">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">My
                            Profile</span></h5>
...
while($rowGetToCart=$resultGetToCart->fetch_array()){ ?>
                        ...
                        Hi <strong><?php echo $_SESSION['customer_fname'];?>
                            <?php echo $rowGetToCart['customer_lname']; ?></strong> Welcome to the<strong>Senaadhi Easy
                            Shipping! </strong>
                        <address><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="inputbdistrict" class="form-label">District</label>
                                    <input class="form-control" type="text" name="bdistrict"
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="inputbpostal" class="form-label">User Role</label>
                                    <input class="form-control" type="text" name="bpostal"
                                        value="<?php echo $rowGetToCart['userRole']; ?>" readonly>
                                </div>
                                <?php
                            ...
                            <div class="mb-5">
                                ...
                                <div class="bg-light p-30">
                                    ...
                                    <div class="col-3">
                                        <a href="N_admin_update_profile.php"
                                            class="btn btn-block btn-danger font-weight-bold py-3">Edit My Profile</a>
                                    </div>
                                </div>
                            </div>
                    </div>
