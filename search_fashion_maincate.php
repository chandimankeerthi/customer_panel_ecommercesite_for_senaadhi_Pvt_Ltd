        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    <form id="filterForm" method="GET">
                        ...
                        <div class="form-group container pt-5 pb-3">
                            <label for="mainCategory">Main Category</label>
                            <select class="form-control" name="mainCategory" id="mainCategory">
                                <?php
            $getMainCategory = "SELECT distinct(mainCat) FROM product_details where product_type='fashion' order by id asc";
            $resultMainCategory = $conn->query($getMainCategory);
            while ($rowMainCat = $resultMainCategory->fetch_array()) {
                $mainCategory = $rowMainCat['mainCat'];
                // Determine if this option should be selected based on the URL parameter
                $selected = ($_GET['mainCategory'] == $mainCategory) ? 'selected' : '';
                ?>
                                <option value="<?php echo $mainCategory ?>" <?php echo $selected ?>>
                                    <?php echo $mainCategory ?></option>
                                <?php
            }
            ?>
                            </select>
                    ...
                    function applyFilters() {
                        ...
                        // Define different actions based on user input
                        if (mainCategory === "Shirt") {
                            // Redirect to search_fashion_maincate.php
                            window.location.href = "search_fashion_subcate_shirt.php?mainCategory=" + mainCategory;
                        }
                        if (mainCategory === "T-shirt") {
                            // Redirect to search_fashion_maincate.php
                            window.location.href = "search_fashion_subcate_tshirt.php?mainCategory=" + mainCategory;
                        } else {


                            // Handle other actions here or add more conditions as needed
                        }
                    }
                    </script>
            ...
            <div class="container pt-5 pb-3">
                <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span
                        class="bg-secondary pr-3">Filtered Results:</span></h4>
                <div class=" row px-xl-5">
