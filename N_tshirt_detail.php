        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
                            ...
                            <select class="form-select" aria-label="Default select example" name="size">
                                ...
                                $getCategory = "SELECT distinct(size) FROM product_details WHERE mainCat='T-shirt' AND Productname='$getCategory1'";

                                        $resultSubCategory2 = $conn->query($getCategory);
        
                                        while ($rowSub2 = $resultSubCategory2->fetch_array()) {
                                        // Split the comma-separated values into an array
                                        $sizes = explode(',', $rowSub2['size']);
            
                                        foreach ($sizes as $size) {
                                        $color = trim($size); // Remove leading/trailing spaces
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="colorfamily">
                            <?php
                                        ...
                                        $getCategory = "SELECT distinct(colorfamily) FROM product_details where mainCat='T-shirt' AND Productname='$getCategory1'";
                                        $resultSubCategory2 = $conn->query($getCategory);
                    ...
                    <input type="number" class="form-control bg-secondary border-0 text-center" value="1" min="0"
                        max="<?php echo $row["productQuantity"];?>" name="quantity">
            ...
            <div class="bg-light p-30">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-pane-1">
                        ...
                        <p>T-Shirt Category :<?php echo $row["sub_categorey"];?></p>
                        ...
                        <p>Collor Type :<?php echo $row["collartype"];?></p>
                        <p>Color Type :<?php echo $row["colorfamily"];?></p>
                        <p>Tee Neckline Types :<?php echo $row["tee_neckline"];?></p>
                        <p>Tee Sleeve Length :<?php echo $row["tee_sleeve"];?></p>
                            ...
                            <div class="col-md-6">
                                ...
                                <form>
                                    ...
                                    <div class="form-group mb-0">
                                        <a><input type="submit" id="userInput" value="Submit Review" name="InsertReview"
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel related-carousel" class="carousel slide">
                    <?php
                    $query = "select * from tshirt_details order by id asc";
                    $result = mysqli_query($conn,$query);
                            if (mysqli_num_rows($result) > 0) {
