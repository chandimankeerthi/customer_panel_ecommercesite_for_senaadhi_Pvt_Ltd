                ...
                <div class="h-100 bg-light p-30">
                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
                            ...
                            <select class="form-select" aria-label="Default select example" name="size">
                                <?php
                                        ...
                                        $getCategory = "SELECT distinct(size) FROM product_details where mainCat='Trouser' AND Productname='$getCategory1'";
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="colorfamily">
                            <?php
                                        $getCategory = "SELECT distinct(colorfamily) FROM product_details where mainCat='Trouser' AND Productname='$getCategory1'";
                                        $resultSubCategory2 = $conn->query($getCategory);
