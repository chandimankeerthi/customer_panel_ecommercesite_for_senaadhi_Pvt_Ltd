...
<body>
                ...
                <div class="bg-light p-4 mb-30">
                    ...
                    function applyFilters() {
                        ...
                        if (productType === "fashion") {
                            ...
                            window.location.href = "search_fashion_maincate.php?productType=" + productType;
                        } else if (productType === "furniture") {
                            // Redirect to search_furniture_maincate.php
                            window.location.href = "search_furniture_maincate.php?productType=" + productType;
                        }
    ...
    <div class="container pt-5 pb-3">
        <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Filtered
                Results:</span></h4>
        <div class=" row px-xl-5">
